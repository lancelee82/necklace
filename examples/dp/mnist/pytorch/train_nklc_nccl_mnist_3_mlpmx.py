...
# python train_ngn_mnist_1.py -r scheduler -w 8 -k 0 -u tcp://127.0.0.1:9399
# ./train_workers.sh 4
# ./train_workers.sh 4


### in 193 x1 : 194 x1  (new + envs)
"""
python train_ngn_mnist_1.py -r scheduler -w 2 -k 0 --epochs 3 -u tcp://192.168.58.193:11001

python train_ngn_mnist_1.py -r worker -w 2 -k 0 --gpus 0 -x nccl -ci eno33 -u tcp://192.168.58.193:12000 -s tcp://192.168.58.193:11001

python train_ngn_mnist_1.py -r worker -w 2 -k 1 --gpus 0 -x nccl -ci eno33 -u tcp://192.168.58.194:12001 -s tcp://192.168.58.193:11001
"""
