...
def main():
    ...
    parser.add_argument('--lr', type=float, default=0.01, metavar='LR',  # for optim.Adam
    ...
    #model = Net().to(device)
    model = MLPMxr(in_channels=1, image_size=28, patch_size=4, num_classes=10,
