"""DataLoader using Multi Processes and One Data Queue"""
...
class DataLoaderSharedMemory(object):
    ...
    def init_qs(self):
        ...
        self.qs_data = mp.Queue(self.part_num * self.cache_n)
    ...
    def init_loaders(self):
        ...
        for i in range(self.cache_n):
            ...
            worker = mp.Process(
                ...
                args=(i, self.qs_msg[i], self.qs_data, self.qs_ctl[i],
    ...
    def __iter__(self):
        ...
        while curr_idx < num_batches:
            ...
            dt = self.qs_data.get()  # (data, label)
...
class DataloaderShmemPart(object):
    ...
    def load(self):
        ...
        while not end_of_batch:
            ...
            try:
                self.q_data.put(next_data_batch)  # block if queue is full
            except Exception as e:
                print('x' * 40, e)
                pass  # next data
