...
class DataLoaderSharedMemory(object):
    ...
    def __init__(self, dataset, batch_size=None, data_shape=None,
        ...
        self.batch_data_shape = (self.batch_size,) + self.data_shape
        ...
        self.shm_data_shape = (self.part_num,) + self.batch_data_shape
        self.shm_label_shape = (self.part_num,) + self.batch_label_shape
    ...
    def reget_shm(self):
        ...
        self.data_shm = [shdnda.SharedMemArray(
            i.name, obj_shape=self.shm_data_shape, sk=i.sk) for i in self.data_shm]
        self.label_shm = [shdnda.SharedMemArray(
            i.name, obj_shape=self.shm_label_shape, sk=i.sk) for i in self.label_shm]
...
class DataloaderShmemPart(object):
    ...
    def init_shm(self):
        ...
        self.data_shm = shdnda.SharedMemArray.create_from_shmem_key(
            self.data_shm_sk, self.shm_data_shape)
        self.label_shm = shdnda.SharedMemArray.create_from_shmem_key(
            self.label_shm_sk, self.shm_label_shape)
